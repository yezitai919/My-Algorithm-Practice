...
public class GA02 {
    ...
    public GA02(int goodNum, int capacity, int[] weight, int[] value, int populationNum, int generationNum, double matingRate, double excellenceRate, double variationRate) {
...
/*        if (a==5){
     ...
     */
    private void mating(){
        for (int i = 0; i < populationNum * excellenceRate; i++) {
            childChromosome[i]=chromosome[adaptiveness[i][0]].clone();
        }
        for (int i = (int)(populationNum *excellenceRate); i < populationNum; i+=2) {
    ...
    public static void main(String[] args) {
        ...
        GA02 ga02 = new GA02(goodNum,capacity,
                weight,value,50,100,0.6,0.1,0.01);
        long s = System.currentTimeMillis();
        ga02.geneticAlg();
        long e = System.currentTimeMillis();
        System.out.println("算法运行时间："+(e-s)+"微秒");
    }
