...
/**
 * @Author jinjun99
 * @Date Created in 2022/3/20 15:13
 * @Description
 * @Since version-1.0
 */
public class GenAlgDemo02 {
    public static void main(String[] args) {
        ...
        GenAlgResources02 gAr01 = new GenAlgResources02(k,m,needs,timeLimit,
        ...
        //初始化种群数据
        GenAlgInitialize02.initialization(gAr01);
/*        for (int i = 0; i < populationNum; i++) {
            System.out.println(Arrays.toString(gAr01.chromosome[i]));
        }*/
        //繁衍迭代
        for (int i = 0; i < gAr01.generationNum; i++) {
            //计算i代的适应度
            GenAlgFitness02.calculateFitness(gAr01);
            //从i代中选择第i+1代的父母染色体
            OperatorSelection02.rouletteWheelSelect(gAr01);
            //父母染色体交叉或复制繁衍子代
            OperatorCrossover02.crossover(gAr01);
            //子代染色体变异并替换父代染色体
            OperatorMutation02.mutation(gAr01);
        }
        //计算结束时间
